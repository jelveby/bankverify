...
describe('Bankgiro - Errors', () => {
  ...
  it('should include TOO_SHORT for numbers shorter than 7 digits', () => {
    bankgiro.init(undefined).errors().should.include(Bankgiro.ERRORS.TOO_SHORT);
    bankgiro.init('').errors().should.include(Bankgiro.ERRORS.TOO_SHORT);
    bankgiro.init('23-1332').errors().should.include(Bankgiro.ERRORS.TOO_SHORT);
    bankgiro.init('92---------8838').errors().should.include(Bankgiro.ERRORS.TOO_SHORT);
  });
  ...
  it('should include INVALID_CHARACTERS for numbers with other character than digits, spaces and dashes', () => {
    bankgiro.init('5402-9681X').errors().should.include(Bankgiro.ERRORS.INVALID_CHARACTERS);
    bankgiro.init(' 5 4 0 2 - 9 6 8 1 ').errors().should.not.include(Bankgiro.ERRORS.INVALID_CHARACTERS);
  });
